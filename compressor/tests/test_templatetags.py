...
{% endcompress %}"""
    ...
    @override_settings(django_csp_nonce=False)
    def test_csp_neg_nonce_tag(self):
        self.context['django_csp_nonce'] = False
        self.context['request'] = {}
        self.context['request']['csp_nonce'] = '123'
        template = """{% load compress %}{% compress js inline %}
        <script src="{{ STATIC_URL }}js/nonasc-latin1.js" charset="latin-1"></script>
        ...
        {% endcompress %}
        """
        out = '<script>var test_value="\xdcberstr\xedng";;var test_value="\u2014";;</script>'
        self.assertEqual(out, render(template, self.context))
